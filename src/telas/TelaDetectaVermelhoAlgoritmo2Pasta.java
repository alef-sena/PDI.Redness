                    ...
                    for(File arqPastaOrigem: pastaOrigem.listFiles()){
                          ...
                          (btnBmpOption.isSelected() && arqPastaOrigem.getName().toLowerCase().endsWith(".bmp")))
                        {
                            try {
                                ...
                                BufferedImage imagemProcessada = ProcessamentoImagem.detectarPeleHumanaLuan(imgOriginal);
                                File fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_RedCIRGLuan"+".png");
