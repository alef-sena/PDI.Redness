 ...
 */
public class TelaDetectaVermelhoAlgoritmo2Pasta extends javax.swing.JFrame {
     ...
     */
    public TelaDetectaVermelhoAlgoritmo2Pasta() {        
        initComponents();
                    ...
                    for(File arqPastaOrigem: pastaOrigem.listFiles()){
                          ...
                          (btnBmpOption.isSelected() && arqPastaOrigem.getName().toLowerCase().endsWith(".bmp")))
                        {
                            try {
                                ...
                                BufferedImage imagemProcessada = ProcessamentoImagem.rednessDetection2(imgOriginal);
