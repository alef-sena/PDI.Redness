 ...
 */
public class TelaDetectaVermelhoAlgoritmoFusaoPasta extends javax.swing.JFrame {
     ...
     */
    public TelaDetectaVermelhoAlgoritmoFusaoPasta() {        
        initComponents();
                    ...
                    for(File arqPastaOrigem: pastaOrigem.listFiles()){
                          ...
                          (btnBmpOption.isSelected() && arqPastaOrigem.getName().toLowerCase().endsWith(".bmp")))
                        {
                            try {
                                ...
                                BufferedImage imagemProcessada = ProcessamentoImagem.rednessFusion(imgOriginal);
