                            ...
                            (btnBmpOption.isSelected() && arqPastaOrigem.getName().toLowerCase().endsWith(".bmp")))
                        {
                            try {
                                ...
                                if(arqPastaOrigem.getName().length() >= 16){
                                    String finalRedness = "RedCIRG2.png";
                                    if(finalRedness.equals(arqPastaOrigem.getName().substring(arqPastaOrigem.getName().length()-16)))
                                        fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 17)+"_RedCIRG2_Otsu"+".png");
                                    else
                                        fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_RedCIRG2_Otsu"+".png");
                                }
                                else{
                                    fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_RedCIRG2_Otsu"+".png");
                                }
